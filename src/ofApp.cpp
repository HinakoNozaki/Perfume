    ...
    void draw(){
        for(int i=0; i<joints.size(); i++){
            if(joints.at(i)->getName()=="Head"){
                ...
                box.set(20, 20);
                //ofVec2f c1(joints.at(i+1)->getPosition()); //
                //cout << c1 << endl; //
                //ofDrawCircle(c1.x-300, c1.y-30, -300, 20);
                //ofDrawCircle(c1.x-300, c1.y-30, 15); //
                box.setPosition(joints.at(i+1)->getPosition());
                box.draw();
            }else if(joints.at(i)->isSite()){
                ofSetColor(117, 249, 77);
                box.set(5, 20);
                ofVec2f c2(joints.at(i)->getPosition()); //
                //cout << c2 << endl; //
                //ofDrawCircle(c2.x, c2.y, 5); //
    ...
    void draw()    {
        ...
        for (int i = 0; i < points.size() - 1; i++){
            ...
            if (dist < 40) {
                ...
                //ofSetColor(89, 197, 202);
                //ofDrawCircle(p0.x, p0.y, p0.z,15);
